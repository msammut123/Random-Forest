...
for x in ntreeArray:
    ...
    forestRecall = []
    forestFScore = []
    rows = openFile("C:/Users/mike1/Documents/Coding Projects/CS589 Machine Learning/Homework 3/datasets/hw3_house_votes_84.csv")#Put the filepath for house_votes_84.csv here
